 ...
 *      so it ships with the GH Pages deploy, stamping the package version into
...
if (process.argv.includes('--to-docs')) {
  ...
  for (const f of files) {
    if (f === 'index.html') {
      writeFileSync(join(docsToolDir, f), stampPackageLabel(readFileSync(join(toolDir, f), 'utf8')));
    } else {
